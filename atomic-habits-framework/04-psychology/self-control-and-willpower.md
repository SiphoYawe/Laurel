...
Self-control and willpower are widely misunderstood. Most people believe that successful individuals possess superior willpower—an unlimited reserve of discipline that allows them to resist temptation and maintain productive habits effortlessly.

**The Reality**: People with the highest self-control are those who need it least. They've engineered their environments to eliminate temptation rather than relying on willpower to resist it.

**Central Paradigm**: Willpower is a limited resource that depletes throughout the day. The solution to behavior change is not to cultivate more willpower, but to design your environment so that willpower becomes unnecessary. Disciplined people are better at avoiding tempting situations than resisting temptation.

---

## Core Concepts

### 1. Willpower is a Limited Resource (Ego Depletion Research)
...
**Conclusion**: Resisting cookies depleted willpower, reducing persistence on subsequent task
...
```
Morning: Willpower Tank = 100%
Decision 1 (resisted breakfast pastry): Tank = 95%
Decision 2 (resisted checking phone): Tank = 90%
Meeting 3 (stayed calm despite frustration): Tank = 85%
Decision 4 (chose salad over burger): Tank = 78%
[Continue throughout day...]
Evening: Willpower Tank = 20%
Decision X (ice cream appears): Resistance fails → Give in
```
...
- Why people binge-watch TV, eat junk food, skip planned activities
...
- Just before end of day: 10% parole granted
...
- Pattern: Willpower depletes → resistance to marketing weakens
...
2. **Making Decisions**:
   ...
   - Any choice, even small

3. **Controlling Emotions**:
   - Staying calm when angry
   - Remaining patient when frustrated
   - Suppressing anxiety

4. **Suppressing Thoughts**:
   - Trying not to think about something
   - Mental control efforts

5. **Performing Difficult Cognitive Tasks**:
   - Complex problem-solving
   - Learning new material
   - Focused concentration

6. **Managing Conflicting Desires**:
   - Wanting to rest but needing to work
   - Wanting junk food but eating healthy
   - Any internal conflict

**The Implication**:

**Every act of self-control depletes your capacity for the next act.**
...
**Conservative Application**: Even if willpower isn't as limited as originally thought, why rely on it when you don't have to?

---

### 2. Why Disciplined People Need LESS Willpower

**The Paradox**:

**Common Belief**: Disciplined people have MORE willpower

**Research Finding**: Disciplined people need LESS willpower
...
**Expected**: High self-control people resist more temptations
...
```
LOW SELF-CONTROL PERSON:
Temptations encountered: 50/day
Resistance required: 50 times
Failures: 15 (30% failure rate)
Willpower drained constantly

HIGH SELF-CONTROL PERSON:
Temptations encountered: 10/day
Resistance required: 10 times
Failures: 1 (10% failure rate)
Willpower preserved
```

**The high self-control person doesn't win by resisting more; they win by being tempted less.**
...
- Success automatic (no willpower needed)
...
- Must resist checking phone constantly
...
- Focus automatic (no willpower needed)
...
- Decision fatigue and willpower drain
...
- Accountability partner expecting them
- Friction removed (minimal willpower needed)

**The Discipline Secret**:
...
- Making good behaviors the path of least resistance

**The Willpower Conservation Strategy**:

```
STEP 1: Identify behaviors requiring willpower
STEP 2: Redesign environment to eliminate need for resistance
STEP 3: Reserve willpower for unavoidable challenges
STEP 4: Succeed more easily with less effort
```
...
- "I rarely need willpower because I engineered that need away"

**The Misconception**:

People admire the disciplined person's apparent willpower and try to cultivate more willpower.

**They should instead**: Copy the disciplined person's environmental design.

**The Meta-Lesson**:

**Don't try to be more disciplined.**

**Try to make discipline unnecessary.**

---

### 3. The Secret: Avoiding Tempting Situations

**The Core Strategy**: Avoidance > Resistance

**The Difficulty Hierarchy**:

```
EASIEST: Never encounter temptation
  ↓
HARDER: Encounter but remove easily
  ↓
HARDER: Encounter and must resist
  ↓
HARDEST: Encounter, resist, repeat multiple times daily
```

**The Strategic Implication**: Invest effort in avoidance (easy), not resistance (hard)
...
- **Pre-commitment device**: Made resistance unnecessary

**Modern Application**: Tie yourself to the mast BEFORE encountering the sirens
...
- At home at 9pm (low willpower, tired): Impossible to resist

**The Leverage**: Use high-willpower moments (grocery store) to prevent low-willpower failures (home)
...
- Make access require multiple steps

**Effect**: 5 seconds of friction prevents impulsive checking
...
- Design daily path to bypass temptations
...
- Choose social activities aligned with desired behaviors
...
**Level 1 (Weak)**: "I won't check social media during work" (Requires constant resistance)

**Level 2 (Better)**: Delete apps from phone (Requires re-download to access)

**Level 3 (Strong)**: Phone stays in car during work (Physical barrier)

**Level 4 (Strongest)**: No smartphone, only basic phone (Impossibility)

**Avoiding Unhealthy Food**:

**Level 1 (Weak)**: "I'll only eat healthy foods" (Requires resistance when junk food present)

**Level 2 (Better)**: Don't buy junk food (Not available at home)

**Level 3 (Strong)**: Grocery delivery with pre-set healthy list (No in-store temptation)

**Level 4 (Strongest)**: Meal prep service (Decision eliminated entirely)

**Avoiding Overspending**:

**Level 1 (Weak)**: "I'll resist impulse purchases" (Requires constant vigilance)

**Level 2 (Better)**: Unsubscribe from marketing emails (Reduce temptation exposure)

**Level 3 (Strong)**: Delete shopping apps, remove saved payment info (Add friction)

**Level 4 (Strongest)**: Automatic savings, only cash for discretionary spending (Impossibility of overspending)
...
- Candy not present: Ate 0 pieces/day
...
**The Pre-Commitment Concept**:

**Definition**: Make future decision in advance, when willpower is high
...
- Bad choice is hard choice
- Success automatic despite low willpower

**The Radical Avoidance**:

**Sometimes optimal strategy is complete avoidance, not moderation**
...
**The Abstinence Violation Effect** warns: For some temptations, moderation requires MORE willpower than abstinence

**The Permission**:

**You don't have to resist every temptation.**

**You can engineer a life where you encounter fewer temptations.**

**This is not weakness. This is wisdom.**

---

### 4. Self-Control as Designing Your Environment

**The Paradigm Shift**:

**Old Definition**: Self-control = Resisting temptation in the moment

**New Definition**: Self-control = Designing environment to avoid temptation

**The Reframe**:

```
LOW SELF-CONTROL: Reactive resistance
  (Temptation arises → Must resist → Often fail)

HIGH SELF-CONTROL: Proactive design
  (Design environment → Temptation doesn't arise → No resistance needed)
```
...
**Effect**: Visual cues trigger desired behaviors automatically
...
- Meditation cushion in easy-to-access spot
- Bills on autopay

**Effect**: Ease overcomes inertia
...
- Tracking progress (satisfying checkmarks)

**Effect**: Positive association reinforces behavior
...
- Phone out of sight
- Video game console packed away
- Cigarettes not in house

**Effect**: No cue = no craving
...
- TV requires multiple steps to watch
- Cigarettes not readily available

**Effect**: Friction exceeds impulse strength
...
- Visual reminder of consequences
- Immediate negative consequence

**Effect**: Cost exceeds benefit

**The Complete Environment Design**:
...
**Result**: Writing is path of least resistance; social media is path of high resistance
...
**Result**: Healthy behaviors easy and visible; unhealthy behaviors difficult and invisible
...
**Result**: Focus easy and automatic; distraction difficult and rare
...
- Their behaviors seem normal to you
...
**The Harsh Reality**: Sometimes changing yourself requires changing your social circle

**The Digital Environment**:

**Often Underestimated**: Your digital environment shapes behavior as much as physical
...
- Use grayscale mode (reduces dopamine appeal)
...
- Curate information diet carefully
...
**Your environment should make good behaviors automatic and bad behaviors difficult.**

**You're not relying on willpower. You're designing a life where willpower is rarely needed.**

---

### 5. Reducing Exposure vs. Resisting Temptation

**The Comparison**:

```
STRATEGY A: Resisting Temptation
  Effort: High, constant
  Willpower Required: Significant, ongoing
  Success Rate: Moderate (willpower depletes)
  Sustainability: Low (exhausting)

STRATEGY B: Reducing Exposure
  Effort: Moderate, one-time
  Willpower Required: Minimal, initial only
  Success Rate: High (temptation absent)
  Sustainability: High (effortless maintenance)
```
...
- Inevitable failures: ~365 (10% failure rate)
...
- Inevitable failures: ~1,800 (10% failure rate)
- Focus constantly interrupted by resisting urge
- Exhausting
...
- Use website blockers
- Exposure to temptation: Near zero
- Resistance events: Near zero
- Failures: Near zero

**The Mathematics of Exposure Reduction**:

**Success Rate Formula**:

```
Success Rate = (1 - Failure_Rate_Per_Instance) ^ Number_of_Instances

RESISTANCE STRATEGY:
Success = (1 - 0.10) ^ 3650 = 0.99^3650 ≈ 0% chance of perfect year

REDUCTION STRATEGY:
Success = (1 - 0.001) ^ 1 = 99.9% chance of success

```

**The Implication**: Even with 90% resistance success rate, over 3,650 instances, you'll fail. With exposure reduction (1 instance), success is nearly guaranteed.
...
- Annual willpower drain: 5 units

**You save 7,295 units of willpower annually** by using reduction instead of resistance.
...
- Attention available for meaningful work

**Effect**: Full cognitive capacity available
...
**Seems Like**: Reduction reduces freedom (fewer options)
...
**Many find the second more liberating.**

**The Common Objections**:

**Objection 1**: "But I should be able to resist temptation"

**Response**: Why make life harder than necessary? Success matters more than proving willpower strength.

**Objection 2**: "Avoidance is weakness"

**Response**: Avoidance is strategic wisdom. Odysseus wasn't weak for tying himself to the mast.

**Objection 3**: "What about willpower training?"

**Response**: Use saved willpower for things you can't avoid. Willpower is too valuable to waste on avoidable temptations.

**Objection 4**: "I should be able to moderate"

**Response**: Maybe. But if you can't (and most can't), elimination is valid strategy.
...
```
Can you eliminate temptation?
  YES → Eliminate it (most efficient)
  NO → Must you encounter it?
    YES → Can you reduce frequency?
      YES → Reduce exposure as much as possible
      NO → Develop resistance skills (least efficient, but necessary)
    NO → Eliminate it (redesign life to avoid)
```
...
- Week 52: Effortless success
- Year 5: Still effortless

**Reduction is set-and-forget. Resistance requires constant effort.**

**The Bottom Line**:

**Resisting temptation is hard, exhausting, and often fails.**

**Reducing exposure is easy, sustainable, and rarely fails.**

**Be strategic, not heroic.**

---

### 6. Why "Just Say No" Fails

**The Slogan**: "Just Say No" (1980s anti-drug campaign)

**The Assumption**: Willpower is sufficient; people just need to choose to resist

**The Reality**: Completely ignored everything we know about human psychology and self-control
...
- Late evening: "Screw it, yes" (willpower exhausted)
...
- But feels like failure → quit trying
...
- Social need still present, intense, unmet
- Return to drugs inevitable (or extreme isolation)
...
- "Just say no" teaches none of this
...
- Expecting individual willpower to overcome this consistently is naive

**The Alternative to "Just Say No"**:
...
- Develop actual skills for unavoidable temptations
...
- Friends still smoke around you
- Eventually fail
...
- Tell friends you quit, ask for support
- Change routine to avoid triggers
...
- Smoking rates reduced dramatically through:
  ...
  - Social stigma changes (alternative social norms)
  - NOT primarily through individuals' willpower

**The Meta-Lesson**:

**"Just Say No" assumes the problem is weak individuals.**

**The reality: The problem is strong environments.**

**Solution: Change the environment, not just the individual decision.**

---

### 7. Automaticity Reduces Willpower Needs

**The Progression**:

```
BEGINNER: High willpower required (every action conscious)
  ↓
INTERMEDIATE: Moderate willpower required (some automaticity)
  ↓
ADVANCED: Low willpower required (mostly automatic)
  ↓
EXPERT: No willpower required (completely automatic)
```

**The Goal**: Move behaviors from conscious effort to automatic execution

**The Automaticity Concept**:
...
- Putting on seatbelt when entering car
- Making coffee upon waking
...
**The shift from conscious to automatic = shift from prefrontal cortex to basal ganglia**

**The Willpower Savings**:
...
**Savings**: 20 willpower units daily = 7,300 units annually

**That willpower can now be used for other important decisions.**
...
**The Timeline**: Varies by behavior complexity, but typical habit automation takes 2-6 months of consistent practice

**The Automation Strategies**:

**Strategy 1: Consistent Context**
...
- Always with same playlist

**Effect**: Context becomes automatic trigger; behavior executes without decision

**Strategy 2: Reduce Decision Points**
...
- Don't decide where to exercise (same location)

**Effect**: No decisions = no willpower drain

**Strategy 3: Implementation Intentions**

**The Principle**: Pre-decide specific action for specific situation
...
- "When clock says 10 PM, I will begin bedtime routine"

**Effect**: Situation triggers behavior automatically, bypassing conscious decision

**Strategy 4: Habit Stacking**

**The Principle**: Attach new habit to existing automatic behavior
...
**Effect**: Existing habit's automaticity pulls new habit along

**Strategy 5: Environmental Design for Automaticity**
...
- Meditation cushion in living room → See it → Automatically sit

**Effect**: Environmental cues trigger automatic responses

**The Automaticity Acceleration**:

**Factors That Speed Automation**:

1. **Consistency**: Same time, place, context every time
2. **Simplicity**: Simpler behaviors automate faster
3. **Frequency**: Daily behaviors automate faster than weekly
4. **Identity**: "I am a person who X" accelerates automation
5. **Reward**: Immediate satisfaction reinforces automaticity

**Factors That Slow Automation**:

1. **Inconsistency**: Different times, places, contexts
2. **Complexity**: Complex behaviors take longer to automate
3. **Infrequency**: Weekly behaviors automate slowly
4. **Ambivalence**: "I should but don't want to" resists automation
5. **Punishment**: Negative experience inhibits automation
...
- It happens even when you're tired or distracted
...
- You feel resistance each time

**The Compound Benefit**:

**One Automatic Behavior** = 20 willpower units saved daily
...
- Maintain self-control in high-stakes situations

**The Goal**: Automate as many beneficial behaviors as possible to conserve willpower for what truly requires it
...
- Examples: Job offer evaluation, major purchase

**The Strategic Allocation**: Use automation for routine behaviors; reserve willpower for exceptional situations

---

### 8. Keystone Habits That Improve Self-Regulation
...
```
REGULAR HABIT: Improves one domain
  Exercise → Better fitness

KEYSTONE HABIT: Improves multiple domains
  Exercise → Better fitness + Better sleep + Better eating + Better focus + Better mood + Improved self-control
```

**The Primary Keystone Habits**:
...
- Enhances focus → Better decision-making
- Builds discipline → Transfers to other domains
- Provides energy → Can tackle more challenging tasks
...
More rested and energetic
  ↓
Better willpower throughout day
  ↓
...
- Being more patient with family

**Exercise doesn't just improve fitness; it improves self-control globally.**
...
- Reduces impulsivity → More thoughtful
- Increases stress resilience → Can handle more
...
Sleep 7-9 hours
  ↓
Wake up with full willpower
  ↓
Make better decisions all day
  ↓
Less stress accumulation
  ↓
Better sleep next night
  [Positive cycle]
```
...
- Significantly reduced self-control
- Poor sleep = 30-50% reduction in willpower capacity

**Sleep doesn't just restore energy; it restores self-control.**
...
- Provides progress visibility → Motivating
- Identifies patterns → Learn from successes/failures
- Reduces cognitive load → Mental clarity
...
- Improves emotion regulation → Less stress eating, etc.
- Builds discipline → Sitting still is willpower training
...
Notice urges without acting
  ↓
Create space between craving and response
  ↓
Choose wisely more often
...
- Increased willpower capacity

**Meditation literally strengthens the brain regions responsible for self-control.**
...
- Improved focus → Better decisions
- Reduced cravings → Easier food choices
...
Eat balanced meals
  ↓
Stable blood sugar all day
  ↓
Consistent willpower (glucose available)
  ↓
...
**Nutrition doesn't just fuel body; it fuels willpower.**

**The Keystone Stack**:

**Combining Keystones Creates Multiplicative Effect**:

```
Exercise + Sleep + Nutrition + Meditation + Planning = Extraordinary Self-Regulation

Each keystone supports others:
- Exercise → Better sleep
- Sleep → Better focus for meditation
- Meditation → Better food choices
- Good nutrition → More energy for exercise
- Planning → Ensures time for all keystones
```
...
```
Month 0: Start exercising (Keystone 1)
Month 3: Exercise automatic, notice better sleep naturally, optimize sleep routine (Keystone 2)
Month 6: Sleep solid, add meditation (Keystone 3)
Month 9: Add daily planning (Keystone 4)
Month 12: Have 4 keystones, self-regulation dramatically improved
```
...
**The Meta-Benefit**: Keystone habits don't just improve self-regulation; they make self-regulation unnecessary for increasing areas of life (through automaticity).

---

### 9. Sleep, Nutrition, Exercise Effects on Willpower

**The Three Pillars of Willpower Capacity**:

These aren't just "healthy habits" - they're the physiological foundation of self-control.
...
- Emotional regulation systems reset
...
- Glucose processing impaired (less fuel for willpower)
...
Choose immediate gratification
  ↓
Examples:
  - Skip workout (too tired)
  - Eat junk food (can't resist)
  - Waste time on social media (can't focus)
  - Snap at loved ones (can't regulate emotion)
  ↓
Feel bad about poor choices
  ↓
Stress increases
  ↓
Sleep worse next night
  [Negative spiral]
...
Good sleep (7-9 hours)
  ↓
Full prefrontal cortex function
  ↓
Strong decision-making
  ↓
Choose long-term benefits
  ↓
Examples:
  - Complete workout
  - Eat nutritious food
...
**Sleep is the foundation. Without it, all self-control efforts are swimming upstream.**
...
- Group B: Given placebo drink
- Second willpower task:
  - Group A: Performance maintained
  - Group B: Performance impaired

**Conclusion**: Glucose is literal fuel for self-control
...
Examples:
  ...
  ↓
Often: Eat more sugar to feel better
  [Negative cycle]
...
BALANCED MEAL (protein, fiber, healthy fat)
  ↓
Blood sugar GRADUAL rise
  ↓
Insulin moderate release
  ↓
Blood sugar STABLE (hours)
  ↓
...
- Complex carbs: Steady glucose supply
...
**The Irony**: Eating well requires willpower, but eating well provides willpower

**The Solution**: Use environment design to eat well effortlessly, which then fuels willpower for other domains
...
- More energy → capacity for difficult tasks

**The Exercise-Willpower Effects**:
...
**Application**: When willpower waning, brief walk can restore capacity
...
**Without explicit intention to change these behaviors**: Exercise improved self-control globally, cascading to all domains
...
**Study**: Regular exercisers handle stressful situations with less willpower depletion than non-exercisers
...
**More is generally better, up to a point** (overtraining depletes willpower)
...
**Best**: Whatever you'll actually do consistently

**The Exercise-Willpower Cascade**:

```
Exercise regularly
  ↓
Immediate: Improved mood, focus, energy
  ↓
Short-term (days): Better sleep → more willpower daily
  ↓
Medium-term (weeks): Reduced stress → less depletion
  ↓
Long-term (months): Structural brain changes → increased baseline willpower
  ↓
Result: Better decisions in ALL life domains
  ↓
Examples:
...
**Exercise requires willpower** (to start, to maintain)

**But exercise provides willpower** (acute and chronic benefits)
...
**Once automatic**: Willpower investment = 0, but willpower returns = massive
...
- All three → Compounding willpower capacity

**The Negative Spiral** (When pillars crumble):
...
**The Positive Spiral** (When pillars strong):
...
```
Week 1-2: Fix sleep (7-8 hours)
Week 3-4: Notice improved willpower, improve nutrition
Week 5-6: Add exercise (energy now available)
Week 7-8: All three pillars strong, willpower dramatically improved
Month 3: New baseline, dramatically increased self-control capacity
```
...
**These aren't optional add-ons. They're the foundation of self-control.**

---

### 10. The Role of Stress and Emotional State

**The Connection**: Stress and emotion are among the strongest predictors of willpower failure
...
**The Stress-Willpower Relationship**:

```
LOW STRESS:
Prefrontal cortex: Strong
Willpower: High
Self-control: Effective
Decisions: Thoughtful, aligned with long-term goals

HIGH STRESS:
Prefrontal cortex: Weakened
Willpower: Low
Self-control: Compromised
Decisions: Impulsive, focused on immediate relief
```
...
- Amygdala (emotion, impulse) activated

**Result**: Stressed person has biology working against self-control

**The Stress-Induced Behaviors**:

**Common Stress Responses** (Reduced willpower):

1. **Stress Eating**:
   - Cortisol increases appetite
   - Cravings for high-calorie comfort food
   - Willpower to resist: Minimal
   - "I deserve this, I'm stressed"
...
5. **Social Withdrawal or Lashing Out**:
   - Emotional dysregulation
   - Say/do things you regret
   - Damage relationships
   - "I just couldn't control myself"

**All are examples of stress overwhelming willpower.**

**The Emotional State Impact**:
...
- Result: Emotions don't overwhelm willpower
...
- Often: Craving passes, clear-headed decision possible
...
- Social connection (stress relief)
- Nature exposure (cortisol reduction)
- Hobbies/play (stress outlet)

**Result**: Lower baseline stress → Higher baseline willpower
...
**Research**: Simply viewing stress as enhancing (not debilitating) reduces cortisol and improves performance

**Technique 4: Stress Inoculation**
...
- Challenging work (stretching capacity)

**Result**: Over time, higher stress threshold, better stress management
...
Depleted willpower
  ↓
Poor decision (stress eating, procrastination, etc.)
  ↓
Guilt/shame
  ↓
More stress
...
Preserved willpower
  ↓
Good decision (aligned with values)
  ↓
Pride/satisfaction
  ↓
Less stress
...
4. Make decisions when calm, not when stressed
...
- "I'll skip workout" (willpower depleted)
- "I'll eat comfort food" (seeking stress relief)
- "I'll watch TV for hours" (avoiding difficult feelings)
...
- Strategy: "I'll do a 10-minute walk first" (stress relief + willpower boost)
- Re-evaluate: "Now I can think clearly"
- Decision: "I'll do a light workout and make a healthy dinner"
- Or: "I'm truly exhausted; I'll rest tonight and get back on track tomorrow"
- Either way: Conscious choice, not impulsive reaction

**The Bottom Line**:

**Stress and negative emotions are willpower enemies.**
...
- Delay decisions when compromised
- Build resilience over time

**The result: Stress doesn't sabotage your self-control.**
...
4. Long-term: Build stress management practices
...
Strategy: Schedule important decisions for high-willpower times
```
...
- Emotional outbursts
- Abandonment of goals during difficult periods
...
- May need to temporarily reduce exposure to undermining relationships
...
- Reserve willpower for unavoidable challenges
...
- Night owl: Don't force 6 AM gym
- Alignment = effortless, misalignment = constant struggle

---

## Summary

Willpower is a limited resource that depletes with use throughout the day. Ego depletion research shows that every act of self-control—resisting temptation, making decisions, controlling emotions—drains a shared willpower tank.

The paradox: People with the highest self-control need it least. They don't resist more temptations; they encounter fewer temptations by designing their environments strategically.

The optimal strategy is avoidance > resistance. Removing temptation from your environment once is more effective than resisting it 3,650 times per year. Environmental design conserves willpower for unavoidable challenges.

"Just Say No" fails because it ignores ego depletion, environmental context, underlying needs, and the automatic nature of cravings. It provides no alternatives, no skills, and creates all-or-nothing thinking.

As habits become automatic, they shift from prefrontal cortex (effortful, depleting) to basal ganglia (automatic, non-depleting). Automaticity eliminates willpower requirements entirely.

Keystone habits—particularly exercise, sleep, adequate nutrition, meditation, and daily planning—create cascade effects that improve self-regulation across all life domains.

The three pillars of willpower capacity are sleep (7-9 hours restores prefrontal cortex function), nutrition (stable blood glucose fuels self-control), and exercise (strengthens prefrontal cortex and provides acute willpower boosts).

Stress and negative emotional states dramatically impair willpower by activating survival mode and suppressing the prefrontal cortex. Managing stress and emotional state is essential for maintaining self-control capacity.

The ultimate strategy: Design your environment to make good behaviors automatic and bad behaviors difficult, optimize the three pillars to maximize willpower capacity, use high-willpower moments (morning, rested, fed) for important decisions, and build keystone habits that cascade into global self-regulation improvements.

Don't try to cultivate more willpower. Design a life where willpower is rarely needed.
